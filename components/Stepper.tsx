...
export default function Stepper({
    ...
    return (
        ...
        >
            <div
                className={`mx-auto w-full max-w-md rounded-4xl shadow-xl border border-slate-200 dark:border-slate-800 ${stepCircleContainerClassName}`}
            >
                <div
                    ...
                    <div className={`px-8 pb-8 ${footerClassName}`}>
                        ...
                        >
                            {!disablePreviousButton && (currentStep !== 1 && (
                                <button
                                    onClick={handleBack}
                                    className={`duration-350 rounded px-2 py-1 transition flex items-center gap-2 cursor-pointer ${currentStep === 1
